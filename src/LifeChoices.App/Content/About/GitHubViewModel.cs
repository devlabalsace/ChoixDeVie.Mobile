...
namespace LifeChoices.App.About.ViewModels
{
    public class GitHubViewModel : BaseViewModel
    {
        private readonly GitHubClient _LifeChoicesGitHubClient = new GitHubClient(new ProductHeaderValue("Xappy"));
        ...
        public async Task OnAppearing()
        {
            ...
            try
            {
                ...
                {
                    var contributors = await _LifeChoicesGitHubClient.Repository.GetAllContributors("davidortinau", "Xappy");
                    if (contributors != null)
                    {
