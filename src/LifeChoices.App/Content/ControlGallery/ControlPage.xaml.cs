...
using LifeChoices.App.Content.ControlGallery.ControlTemplates;
using LifeChoices.App.Content.ControlGallery.ProppyControls;
...
namespace LifeChoices.App.ControlGallery
{
    ...
    public partial class ControlPage : ContentPage
    {
        ...
        protected override void OnAppearing()
        {
            ...
            {
                ControlTemplate = (View)Activator.CreateInstance(Type.GetType($"LifeChoices.App.Content.ControlGallery.ControlTemplates.{_vm.ControlTemplate}"));
            }
            else
            {
    ...
    public class LifeChoicesPropertySelector : DataTemplateSelector
    {
