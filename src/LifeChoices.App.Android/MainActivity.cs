...
using LifeChoices.App.Styles;

[assembly: Android.App.MetaData("com.google.android.maps.v2.API_KEY", Value = LifeChoices.App.ApiConstants.GoogleMapsKey)]
namespace LifeChoices.App.Droid
{
    [Activity(
        Label = "LifeChoices.App", 
        Icon = "@mipmap/icon", 
